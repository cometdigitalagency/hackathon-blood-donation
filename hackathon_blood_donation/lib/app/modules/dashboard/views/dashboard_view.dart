      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Container(
            ...
            child: Obx(() => Row(
                  ...
                  children: [
                    buttomAppBarItem(context, page: 0, label: "home", svgPath: SvgConstants.homeIcon),
                    buttomAppBarItem(context, page: 1, label: "donate", svgPath: SvgConstants.bloodBagIcon),
                    buttomAppBarItem(context, page: 2, label: "profile", svgPath: SvgConstants.userProfileIcon),
                  ],
                ))),
      ),
    );
